...
public class PKCS7RSAMutliSignFileTest {
	...
	public static void main(String[] args) throws IOException, CertificateException {
		...
		String p7signedFileName2 = SelfConfig.orgFileName+".p7s.p7s";
		...
		timeutil.check();
		System.out.println("PKCS7 " + certutil.getSigAlgName() + " ��뷮 ���� Signed ù��°���: \n" + issign);
		
		timeutil = new TimeUtil();
		try {
			issign = p7util.addDetachedSign(keyBytes, SelfConfig.passwd, certBytes, SelfConfig.orgFileName, p7signedFileName, p7signedFileName2, 1);
		} catch (Exception e) {
			System.out.println("Error : [" + p7util.getErrorMsg() + "]");
			return;
		}
		timeutil.check();
		System.out.println("PKCS7 " + certutil.getSigAlgName() + " ��뷮 ���� Signed �ι�°���: \n" + issign);
		...
		/**
			p7 ���ڼ��� ������ ��ȿ���� üũ�Ѵ�.
		*/
		bverify = p7utilverify.verifyDetachedFromFile(SelfConfig.orgFileName, p7signedFileName2, 1);
		
		if(bverify){
			System.out.println("PKCS7 " + certutil.getSigAlgName() + " ��뷮 ���� Signed �������: " + bverify );
		}else{
